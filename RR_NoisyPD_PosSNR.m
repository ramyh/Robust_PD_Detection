...
clear; clc;
% Generate data
load SpectrumNPD_AWGN_Pos_20.mat
data = SpectrumNPD_AWGN_Pos_20;
...
SpectrumNPD_AWGN_Pos_20_Sparse = SpectrumNPD_AWGN_Pos_20(:,ind);
csvwrite('SpectrumNPD_AWGN_Pos_20_Sparse.csv', SpectrumNPD_AWGN_Pos_20_Sparse,1,0);